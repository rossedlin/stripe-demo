                ...
                <div class="collapse navbar-collapse align-items-center flex-sm-row" id="navBar">
                    <ul id="js-scroll-nav"
                        ...
                        <li class="nav-item g-mr-15--lg g-mb-7 g-mb-0--lg">
                            <a href="https://www.rossedlin.com/" class="nav-link p-0">Home <span class="sr-only">(current)</span></a>
                        </li>

                        <li class="nav-item g-mx-15--lg g-mb-7 g-mb-0--lg">
                            <a href="https://www.rossedlin.com/contact" class="nav-link p-0" target="_blank">Contact</a>
                        </li>
                    </ul>
                </div>
                <!-- End Navigation -->
